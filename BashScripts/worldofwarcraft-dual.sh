...
#winePathD3D11=/opt/'wine-tkg-git-worldofwarcraft-4.11.r2.gfad0c725'/bin
#winePathD3D11=/opt/'wine-tkg-git-worldofwarcraft-4.12.1.r2.ge0bf5ac7'/bin
winePathD3D11=/opt/wine-tkg-git-worldofwarcraft-dx11-4.12.1.r2.ge0bf5ac7/bin

# direct x12
#winePathD3D12=/opt/'wine-tkg-git-d9vk-dxvk-vkd3d-faudio-4.8.r0.g3134cc0b'/bin
#winePathD3D12=/opt/'wine-tkg-git-worldofwarcraft-4.11.r2.gfad0c725'/bin
winePathD3D12=/opt/'wine-tkg-git-worldofwarcraft-4.12.1.r2.ge0bf5ac7'/bin
...
if [[ "$_resetPrefix11" == true ]]
then 
	_resetPrefixD3D11=true
fi 

if [[ "$_resetPrefix12" == true ]]
then 
...
then 
	...
	cd "/run/media/lars/work/PackageBuilds/dxvk-tools/"
	./updxvk "$winePrefixD3D12"
...
_defaultArgs="-windowed -maximized -1920x1080"
